                ...
                <div id="newsSecondSection" className="container-fluid">
                    <div className="row">
                        <div className="col-md-7">
                            ...
                            <p class="push">The company stated this on Sunday during a visit by a delegation led by the Minister of State for Petroleum Resources, Chief Timipre Sylva, to the refinery site in Lagos.<br/><br/>
